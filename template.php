...
function d7_simple_breadcrumb($vars) {
...
/*
function d7_simple_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/

function d7_simple_preprocess_page(&$vars,$hook) {
...
/*
function d7_simple_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function d7_simple_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_simple_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_simple_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function d7_simple_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_simple_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/

function d7_simple_form_search_block_form_alter(&$form, &$form_state, $form_id) {
